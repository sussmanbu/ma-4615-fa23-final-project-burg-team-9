...
ggplot() + geom_sf(data = md, aes(fill = pct)) + facet_wrap(~variable, labeller = as_labeller(race_list)) + theme(text = element_text(size = 8), axis.text.x = element_text(angle = 45))
```
